...
export default function TopRatedTvCard() {
  let {topRatedTv} = useSelector((state)=>state.apiDataSlice_In_Store)
  ...
  return <>
    <div className='flex md:justify-start justify-center items-center px-5 py-3 mt-[10px]'> 
        ...
        <span className='text-[30px] text-white'> Top  Rated TV</span> 
    </div>
    <div className='grid lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-5 p-5'>
      {
        topRatedTv.slice(0,10).map((movie , index)=>(
